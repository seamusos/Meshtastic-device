...
#define SX1262_CS (13)      // LORA SPI CS P1.06
#define SX1262_DIO1 (10)    // 
#define SX1262_BUSY (11)    // P1.04
#define SX1262_RESET (12)    // P0.03
// #define SX1262_ANT_SW (32 + 10) // P1.10
#define SX1262_RXEN (9)
#define SX1262_TXEN (6)
